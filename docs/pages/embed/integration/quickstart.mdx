...
type IdleOptions = {
  ...
  idleTimeout?: number; // timeout in ms, default is 30 minutes
...
> Sample implementation to demonstrate how this could look in your app: [NFID Playground](https://playground.nfid.one)