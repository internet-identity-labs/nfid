...
- Plain signatures are supported for the schemes [Ed25519](https://ed25519.cr.yp.to/index.html) or [ECDSA](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.186-4.pdf) on curve P-256 (secp256r1), using SHA-256 as the hash function, as well as on the Koblitz curve (secp256k1).
...
- [ECDSA](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.186-4.pdf) on curve P-256 (secp256r1), using SHA-256 as the hash function.
- [RSA PKCS#1v1.5 (RSASSA-PKCS1-v1_5)](https://datatracker.ietf.org/doc/html/rfc8017#section-8.2), using SHA-256 as the hash function.
...
This section makes forward references to other concepts in this document, in particular the [certification](https://internetcomputer.org/docs/current/references/ic-interface-spec#certification) section.
