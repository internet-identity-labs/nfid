...
description: "With DFINITY's support, the NFID team will release the open-source tool `@nfid/identity-kit`, to resolve the wallet compatibility challenges. This package will enable developers to incorporate a broad spectrum of functionalities, paving the way for a more interconnected and efficient application environment."
date: "2023-12-12"
...
[Technical draft](../identity-kit/icrc-33-call-canister)
