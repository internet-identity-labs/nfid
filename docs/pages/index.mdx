...
Use the [interactive playground](https://playground.nfid.one), view a live implementation in [NFID Vaults](https://nfidvaults.com),
and then get started with [installation](/getting-started/installation).