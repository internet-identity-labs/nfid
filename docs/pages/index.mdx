...
NFID Vaults is the only decentralized multi-chain multi-sig that users have a frontend they can use
on https://nfidvaults.com, and that developers can build on top of with the
[NFID Vaults SDK](https://github.com/internet-identity-labs/nfid/tree/main/packages/vaults).
